...
public class JM2TElementPatternFilter extends PatternFilter {
	protected boolean isLeafMatch(Viewer viewer, Object element) {
		...
		if (element instanceof IGeneratorType && matchesGeneratorType((IGeneratorType) element))
			return true;
...
//	}
	...
	protected boolean matchesGeneratorType(IGeneratorType rt) {
