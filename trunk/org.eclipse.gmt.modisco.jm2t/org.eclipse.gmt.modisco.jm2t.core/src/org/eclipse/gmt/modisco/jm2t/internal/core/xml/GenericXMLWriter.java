...
public class GenericXMLWriter extends PrintWriter {
	...
	public void printTag(String name, Map parameters, boolean insertTab,
			boolean insertNewLine, boolean closeTag) {
		if (insertTab) {
		...
		if (parameters != null) {
			...
			Arrays.sort(entries, new Comparator() {
				public int compare(Object o1, Object o2) {
					...
					return ((String) entry1.getKey()).compareTo((String) entry2
							.getKey());
				}
			});
