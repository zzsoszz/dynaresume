...
public class WebSocketServletTemplate
{
  ...
  protected final String TEXT_103 = NL + "\t\t}" + NL + "" + NL + "\t\t/*" + NL + "\t\t * @see org.eclipse.jetty.websocket.WebSocket#onDisconnect()" + NL + "\t\t */" + NL + "\t\tpublic void onDisconnect() {" + NL + "\t\t\tmembers.remove(this);" + NL + "\t\t}" + NL + "\t}" + NL;
