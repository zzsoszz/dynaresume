...
import org.eclipse.gmt.modisco.jm2t.internal.ui.viewers.TableLayoutComposite;
...
public class ListDialogField<T> extends DialogField {
	 ...
	 */
	public ListDialogField(IListAdapter<T> adapter, String[] buttonLabels,
	 ...
	 */
	public int getIndexOfElement(T elem) {
