...
import org.eclipse.gmt.modisco.jm2t.modelconverter.javamodisco.internal.core.JavaModiscoCore;
import org.eclipse.gmt.modisco.jm2t.modelconverter.javamodisco.internal.core.Messages;
		...
		Job job = new Job(
			...
			protected IStatus run(final IProgressMonitor monitor) {
				...
				try {
					...
					JavaModiscoCore.getDefault().getLog().log(status);
				} finally {
					monitor.done();
					try {
						// refresh the folder
